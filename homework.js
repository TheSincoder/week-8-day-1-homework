...
let geralt = new Human('Geralt', 90);
let yennefer = new Human('Yennefer', 100);
...
let myString = 'this is a big string'
// let myString = 'small str'
...
async function statement(x){
    const newCheck = await isBigString(x);
        if(newCheck){
            console.log(`String is Big, Big String is True True`);
        }
    else{
      
        console.log(`String is small, Big String is Big False`)
    }
...
console.log('Caveman write good code');